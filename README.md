<div align="center">
  ...
  [![Python Versions](https://img.shields.io/pypi/pyversions/jax-gemini.svg)](https://pypi.org/project/jax-gemini/0.1.1/)
...
Install via [PyPI](https://pypi.org/project/jax-gemini/0.1.1/):
```bash
