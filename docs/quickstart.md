...
## Prerequisites
Ensure that you have installed the package via [PyPI (`jax-gemini`)](https://pypi.org/project/jax-gemini/) either in your virtual environment or Jupyter notebook.
